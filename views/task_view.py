    ...
    while True:
        ...
        try:
            if choice == "1":
                ...
                date_input = input("Nueva Fecha (DDMMYYYY): ").strip()
                ...
                try:
                    date = datetime.strptime(date_formateada, "%d/%m/%Y").date()
                    if date < date.today():
                ...
                try:
                    ...
                    updated = update_task(tid, title, desc, date)
                    if updated:
                ...
                try:
                    ...
                    print(Fore.GREEN + "Tarea eliminada." if deleted else Fore.RED + "No se pudo eliminar.")
